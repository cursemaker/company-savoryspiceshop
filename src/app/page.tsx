    ...
    <div className="max-w-screen overflow-hidden">
      <section title="banner" className="h-[560px] w-full">
        <div className="flex items-stretch flex-wrap max-md:flex-col">
          ...
          <div className="md:px-20 px-8 md:max-w-[35%] flex flex-col items-start justify-center w-full md:min-h-[560px] h-full py-8 bg-[#B4BA74]">
      ...
      <section title="shopify-section">
        <div title="prduct-section-container" className="md:my-[4.78125rem] my-[1.875rem] sm:px-[25px] max-w-[1400px] mx-auto overflow-x-auto">
      ...
      <section title="category">
        <div title="container-wrapper" className="max-w-[2200px] mx-auto">
          <div title="container-grid-wrapper" className="max-w-[1440px] max-md:flex max-md:flex-col max-md:justify-center md:p-[75px_100px] p-[20px_36px] mx-auto">
      ...
      <section title="view-all">
        <div title="custom-container-wrapper" className="bg-[#88a53d] max-w-[2200px] mx-auto">
          <div className="flex md:flex-row flex-col items-center justify-between w-full md:p-[45px_100px] p-[20px_36px] bg-[url('https://www.savoryspiceshop.com/cdn/shop/files/veggies.png?v=1627593766')] bg-center bg-no-repeat">
            ...
            <Link href="" className="font-bold md:text-[30px] text-2xl  max-md:mt-8 leading-9 text-white md:W-[40%] underline">
      ...
      <div title="featured-collection">
        <section
          ...
          className="max-w-[2200px] md:p-[75px_100px] p-[20px_36px] flex max-md:flex-col justify-between relative overflow-hidden">
          ...
          <div title="featured-collection-content" className="md:w-[60%] cursor-grab md:mt-[1.96875rem] mb-[16px] overflow-x-auto">
      ...
      <div title="home-story">
        <div title="custom-container-wrapper" className="max-w-[2200px] mx-auto">
          <div title="home-story-content" className="flex max-md:flex-col md:flex-wrap max-w-[1440px] md:p-[75px_100px] p-[20px_36px] mx-auto">
      ...
      <div title="home-logos" className="w-full">
        <div title="custom-container-wrapper" className="flex flex-wrap max-w-[2200px] mx-auto bg-[#f6f6f6]">
          <div title="custom-container-wrapper-grid" className="w-full max-w-[1440px] md:p-[75px_100px] p-[20px_36px] mx-auto">
            <h2 className="text-left font-black text-4xl leading-[43px] my-[0.83em]">{`Who's Talking About Us`}</h2>
            <div title="home-logo-wrapper" className="md:mt-[60px] max-md:grid max-md:grid-cols-2 max-md:gap-5 max-w-4xl">
      ...
      <div title="insta-home">
        <div title="custom-container-wrapper" className="max-w-[2200px] mx-auto">
          <div title="custom-container-wrapper-grid" className="max-w-[1440px] md:p-[75px_100px] p-[20px_36px] mx-auto text-center">
            <Link
              href=""
      ...
      <div title="insta-post">
        <div title="insta-feed" className="md:w-[85%] w-full relative text-center mx-auto md:overflow-x-hidden overflow-x-auto clear-both">
