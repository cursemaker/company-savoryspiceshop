...
const TeamMemberCard = React.memo(({ member }: { member: IRandomTeamMember }) => (
    ...
    <TeamErrorBoundary>
      <div>
        <section className='text-gray-600 body-font md:p-[75px_100px] p-[20px_40px]'>
          <div className='container px-5 md:py-6 pt-6 mx-auto'>
            <div className='flex flex-col text-left w-full mb-20'>
              <h1 className='max-md:text-2xl text-4xl font-bold title-font md:mb-4 mb-2 py-4 text-center text-gray-900'>OUR TEAM</h1>
